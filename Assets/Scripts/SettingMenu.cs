...
public class SettingMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (musicManager != null)
        {
            ...
            musicSlider.onValueChanged.AddListener(delegate { musicManager.SetMusicVolume(musicSlider.value); });
            sfxSlider.onValueChanged.AddListener(delegate { musicManager.SetSFXVolume(sfxSlider.value); });
        }
        else
        {
